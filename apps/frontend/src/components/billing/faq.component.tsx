  ...
  return [
      ...
      ? [
          {
            title: t(
              ...
              'Am I going to be charged by MAXX CLIPZ?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_postiz_will_hold',
              'To confirm credit card information MAXX CLIPZ will hold $2 and release it immediately'
            ),
          },
        ]
      : []),
    {
      title: t(
        ...
        `Can I trust ${isGeneral ? 'MAXX CLIPZ' : 'Gitroom'}?`
      ),
      description: t(
        'faq_postiz_gitroom_is_proudly_open_source',
        `${
          isGeneral ? 'MAXX CLIPZ' : 'Gitroom'
        } is proudly open-source—forked from the Postiz project! We believe in an ethical and transparent culture, meaning that ${
          isGeneral ? 'MAXX CLIPZ' : 'Gitroom'
